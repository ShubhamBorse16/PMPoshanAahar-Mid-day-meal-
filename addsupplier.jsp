        ...
        <div class="container">
            <div class="top-map">
                <div class="row map-content-9" style="margin-top:-50px;">
                    <div class="col-lg-8">
                        <h3 class="title-big">School Registration FormForm</h3>
                        <p class="mb-4 mt-lg-0 mt-2">Enter School details</p>
                        <form action="AddSupplier" method="post" class="text-right">
                            <div class="form-grid">
                                <input type="text" name="supplier_name" id="w3lName" placeholder="Supplier Name " required="">
                             	<input type="text" name="supplier_email" id="w3lName" placeholder="Supplier Email" required="">
                               	<input type="text" name="supplier_contact" id="w3lName" placeholder="Supplier Contact" required="">
                               	<input type="text" name="lat" id="w3lName" value="<%=lat %>"  placeholder="Latitude " required="">
                               	<input type="text" name="lang" id="w3lName" value="<%=lang %>" placeholder="Longitude" required="">
                               	<input type="text" name="supplier_password" id="w3lName" placeholder="Supplier Password" required="">
                            </div>
