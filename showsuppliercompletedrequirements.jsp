            ...
            <div class="search-right">
              ...
              <div id="search" class="pop-overlay">
                  <div class="popup">
                      ...
                      <form action="showsuppliercompletedrequirements.jsp" method="post" class="search-box">
...
if (rtitle != null && !rtitle.isEmpty()) {
    try {
        ...
        PreparedStatement ps1 = con.prepareStatement("SELECT * from requirement_tbl where rtitle=? and status=?");
...
%>
                     ...
                     Connection con = ConnectDB.connect();
 					try{
 		        PreparedStatement ps1 = con.prepareStatement("SELECT * from requirement_tbl where supplier_email=? and status=?");
