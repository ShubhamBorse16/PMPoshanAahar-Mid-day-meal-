        ...
        <div class="container">
            <div class="top-map">
                <div class="row map-content-9" style="margin-top:-50px;">
                    <div class="col-lg-8">
                        <h3 class="title-big">Admin Login Form</h3>
                        <p class="mb-4 mt-lg-0 mt-2">Enter admin details</p>
                        <form action="AdminLogin" method="post" class="text-right">
                            <div class="form-grid">
                                <input type="text" name="admin_email" id="w3lName" placeholder="Admin Email" required="">
                                <input type="password" name="admin_password" id="w3lSender" placeholder="Admin Password" required="">
