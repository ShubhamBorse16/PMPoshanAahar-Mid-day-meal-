      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav w-100">
          ...
          <li class="nav-item @@about__active">
            <a class="nav-link" href="supplierpannel.jsp">Supplier Pannel</a>
          </li>
              ...
              <div id="search" class="pop-overlay">
                  <div class="popup">
                      ...
                      <form action="showschools.jsp" method="post" class="search-box">
                          <input type="search" placeholder="Enter Keyword" name="school_name" required="required"
                              autofocus="">
        ...
        <div class="container">
            <div class="top-map">
                <div class="row map-content-9" style="margin-top:-50px;">
 		        ...
 		        PreparedStatement ps1 = con.prepareStatement("SELECT * from supplier_tbl where supplier_email=? and supplier_password=?");
 		        String a=User.getSupplierEmail();
 		        String b=User.getSupplierPassword();
 		        ps1.setString(1,a);
 		       ps1.setString(2,b);
