            ...
            <div class="top-map">
                <div class="row map-content-9" style="margin-top:-50px;">
                    <div class="col-lg-8">
                        ...
                        <form action="AddSchool" method="post" class="text-right">
                            <div class="form-grid">
                                <input type="text" name="school_name" id="w3lName" placeholder="School Name " required="">
                             	<input type="text" name="school_email" id="w3lName" placeholder="School Email" required="">
                               	<input type="text" name="school_contact" id="w3lName" placeholder="School Contact" required="">
                               	...
                               	<input type="text" name="school_password" id="w3lName" placeholder="School Password" required="">
                            </div>
