        ...
        <div class="container">
            <div class="top-map">
                <div class="row map-content-9" style="margin-top:-50px;">
                    <div class="col-lg-8">
                        <h3 class="title-big">Suuplier Login Form</h3>
                        <p class="mb-4 mt-lg-0 mt-2">Enter Supplier details</p>
                        <form action="SupplierLogin" method="post" class="text-right">
                            <div class="form-grid">
                                <input type="text" name="supplier_email" id="w3lSender" placeholder="Supplier Email-Id" required="">
                               <input type="password" name="supplier_password" id="w3lSender" placeholder="Supplier Password" required="">
                            </div>
