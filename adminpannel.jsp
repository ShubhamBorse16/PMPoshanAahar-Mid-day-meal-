        ...
        <ul class="navbar-nav w-100">
         <!--  <li class="nav-item active">
          ...
          <li class="nav-item @@about__active">
            <a class="nav-link" href="showschools.jsp">Schools</a>
          </li>
          <li class="nav-item @@causes__active">
            <a class="nav-link" href="showsuppliers.jsp">Supplier</a>
          </li>
          <li class="nav-item @@contact__active">
            <a class="nav-link" href="schoolrequirements.jsp">School requirements</a>
          </li>
           <li class="nav-item @@contact__active">
            <a class="nav-link" href="studentrecord.jsp">Students records</a>
          </li>
          ...
          <li class="align-self">
            <a href="#donate" class="btn btn-style btn-primary ml-lg-3 mr-lg-2"></span> Donate</a>
          </li>
        </ul>
      </div>
