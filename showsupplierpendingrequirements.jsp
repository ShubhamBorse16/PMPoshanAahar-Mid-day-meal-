            ...
            <div class="search-right">
              ...
              <div id="search" class="pop-overlay">
                  <div class="popup">
                      ...
                      <form action="showsupplierpendingrequirements.jsp" method="post" class="search-box">
                          <input type="search" placeholder="Enter Requirement Table" name="rtitle" required="required"
                              autofocus="">
