        ...
        <ul class="navbar-nav w-100">
         <!--  <li class="nav-item active">
          ...
          <li class="nav-item @@about__active">
            <a class="nav-link" href="showpiechart.jsp">Pie-chart Analysis</a>
          </li>
         
           <li class="nav-item @@contact__active">
            <a class="nav-link" href="schoolpannel.jsp">School Page</a>
          </li>
           <li class="nav-item @@contact__active">
            <a class="nav-link" href="addstudent.jsp">Add Student</a>
          </li>
           <li class="nav-item @@contact__active">
            <a class="nav-link" href="showstudents.jsp">Show Students records</a>
          </li>
