            ...
            <div class="search-right">
              ...
              <div id="search" class="pop-overlay">
                  <div class="popup">
                      ...
                      <form action="showschools.jsp" method="post" class="search-box">
                          <input type="search" placeholder="Enter School Name" name="school_name" required="required"
                              autofocus=""> 
...
if (schoolName != null && !schoolName.isEmpty()) {
    try {
        ...
        PreparedStatement ps1 = con.prepareStatement("SELECT * from school_tbl where school_name=?");
        ps1.setString(1, schoolName);
...
%>
            ...
            %>
 				...
 				<td> <a href="ApproveSpecific.jsp?school_email=<%=rs.getString("school_email")%>">Approve</a></td>
 				<% }
 				else{%>
 			<td> <a href="DisApproveSpecific.jsp?school_email=<%=rs.getString("school_email")%>">Disapprove</a></td>
 				<% }
 				%>
 	</td>
 				</tr>
...
%>
                     ...
                     Connection con = ConnectDB.connect();
 					try{
 		        PreparedStatement ps1 = con.prepareStatement("SELECT * from school_tbl");
 				ResultSet rs = ps1.executeQuery();
 				while(rs.next())
 				{
